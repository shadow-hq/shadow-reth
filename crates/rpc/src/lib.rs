...
use shadow_reth_common::setup_sqlite_db;
use sqlx::Pool;
    ...
    Provider: BlockNumReader + BlockReaderIdExt + Clone + Unpin,
{
    ...
    pub async fn new(
        ...
        Ok(Self { provider, pool: setup_sqlite_db(db_path).await? })
    }
}
...
mod tests {
    ...
    use shadow_reth_common::seed_test_data;
    ...
    async fn test_shadow_get_logs() {
        ...
        seed_test_data(&rpc.pool).await.unwrap();
        ...
        let expected = GetLogsResponse {
            ...
            result: vec![
                GetLogsResult {
                    ...
                    data: "".to_string(),
